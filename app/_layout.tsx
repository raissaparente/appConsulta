...
export default function LayoutRaiz() {
  return (
    <Stack>
      ...
      <Stack.Screen name="agendamento/escolher-especialidade" options={{ title: 'Nova Consulta' }} />
      <Stack.Screen name="agendamento/escolher-medico" options={{ title: 'Nova Consulta' }} />
      <Stack.Screen name="agendamento/escolher-horario" options={{ title: 'Nova Consulta' }} />
      <Stack.Screen name="agendamento/confirmar" options={{ title: 'Confirmar Agendamento' }} />
